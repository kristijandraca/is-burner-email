...
- **[tompec/disposable-email-domains](https://github.com/tompec/disposable-email-domains)** — JSON-formatted, very broad coverage (successor to the now-unmaintained `ivolo/disposable-email-domains`)
