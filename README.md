...
| **Kotlin / JVM** | [Maven Central](https://central.sonatype.com/artifact/io.github.kristijandraca/is-burner-email) | `implementation("io.github.kristijandraca:is-burner-email:1.2.0")` | [`packages/kotlin/`](./packages/kotlin) |
